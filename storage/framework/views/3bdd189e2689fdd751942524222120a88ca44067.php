...
<html>
    <head>
        ...
        <script src="<?php echo e(url('script/home.js')); ?>" defer></script>
    ...
    <body>
        <header>
            <nav class="navbar">
                <div class="nav-logo">
                    ...
                    <a href="<?php echo e(url('home')); ?>">Alicya Alderuccio</a>
                </div>
            ...
            <div id="container">
                <div id="titoli">
                    ...
                    <p>Ehi ciao <strong><?php echo e(Session::get('user_username')); ?></strong> , mi chiamo <strong>Alicya</strong></p>
        ...
        <article id="album">
            ...
            <section>
                <p id="albumlink">Visualizza le immagini salvate all'interno del tuo <a href="<?php echo e(url('profile')); ?>" class="nav-link">profilo</a> personale</p>
            </section>
...
</html><?php /**PATH C:\Users\elian\Desktop\hw2\resources\views/home.blade.php ENDPATH**/ ?>